...
const en = {
  ...
  importSingleDoc: 'Import Single Files',
  loadingDocument: 'Loading…',
  backupDraftSuffix: '(unsaved copy)',
  backupIncludesDraft: 'The backup includes your unsaved draft as a separate copy.',
  ...
  tableInsertCustom: 'Insert custom size',
  tableInsertAction: 'Insert',
  tableTools: 'Table',
  tableInsertGroup: 'Insert',
  tableDeleteGroup: 'Delete',
  ...
  tableHeaderRowToggle: 'Header row',
  tableHeaderColumnToggle: 'Header column',
  tableCellFill: 'Cell fill',
  tableSetCellFill: 'Set cell fill to {color}',
  tableClearFill: 'Clear cell fill',
  tableBordersVisible: 'Show borders',
  tableBordersHidden: 'Hide borders',

  // Smart graphics
  toolbarInsertGraphic: 'Insert graphic',
  graphicGalleryTitle: 'Insert Graphic',
  graphicGalleryDescription: 'Choose a layout, then edit the text directly in the shapes.',
  graphicCategoryList: 'List',
  graphicCategoryProcess: 'Process',
  graphicCategoryCycle: 'Cycle',
  graphicCategoryHierarchy: 'Hierarchy',
  graphicCategoryRelationship: 'Relationship',
  graphicCategoryMatrix: 'Matrix',
  graphicCategoryPyramid: 'Pyramid',
  graphicLayoutListBlock: 'Block List',
  graphicLayoutListHorizontal: 'Horizontal List',
  graphicLayoutProcessChevron: 'Chevron Process',
  graphicLayoutProcessSteps: 'Step Process',
  graphicLayoutCycleBasic: 'Basic Cycle',
  graphicLayoutHierarchyOrg: 'Organization',
  graphicLayoutRelationshipOpposing: 'Opposing Ideas',
  graphicLayoutRelationshipRadial: 'Radial',
  graphicLayoutMatrixGrid: 'Grid Matrix',
  graphicLayoutPyramidBasic: 'Pyramid',
  graphicTools: 'Graphic',
  graphicTextPane: 'Text pane',
  graphicAddItem: 'Add item',
  graphicRemoveItem: 'Remove item',
  graphicMoveUp: 'Move up',
  graphicMoveDown: 'Move down',
  graphicPromote: 'Promote',
  graphicDemote: 'Demote',
  graphicLayout: 'Layout',
  graphicColorSet: 'Colors',
  graphicStyle: 'Style',
  graphicStyleFilled: 'Filled',
  graphicStyleOutline: 'Outline',
  graphicStyleSubtle: 'Subtle',
  graphicStyleIntense: 'Intense',
  graphicColorTheme: 'Theme',
  graphicColorBlue: 'Blue',
  graphicColorGreen: 'Green',
  graphicColorOrange: 'Orange',
  graphicColorPurple: 'Purple',
...
const de: TranslationCatalog = {
  ...
  loadingDocument: 'Wird geladen…',
  backupDraftSuffix: '(ungespeicherte Kopie)',
  backupIncludesDraft: 'Die Sicherung enthält deinen ungespeicherten Entwurf als separate Kopie.',
  ...
  tableInsertCustom: 'Benutzerdefinierte Größe einfügen',
  tableInsertAction: 'Einfügen',
  tableTools: 'Tabelle',
  tableInsertGroup: 'Einfügen',
  tableDeleteGroup: 'Löschen',
  tableInsertRowAbove: 'Zeile oberhalb einfügen',
  tableInsertRowBelow: 'Zeile unterhalb einfügen',
  tableInsertColLeft: 'Spalte links einfügen',
  tableInsertColRight: 'Spalte rechts einfügen',
  ...
  tableSplitCell: 'Zelle teilen',
  tableHeaderRowToggle: 'Kopfzeile',
  tableHeaderColumnToggle: 'Kopfspalte',
  tableCellFill: 'Zellenfüllung',
  tableSetCellFill: 'Zellenfüllung auf {color} setzen',
  tableClearFill: 'Zellenfüllung entfernen',
  tableBordersVisible: 'Rahmen anzeigen',
  tableBordersHidden: 'Rahmen ausblenden',
  toolbarInsertGraphic: 'Grafik einfügen',
  graphicGalleryTitle: 'Grafik einfügen',
  graphicGalleryDescription: 'Wähle ein Layout und bearbeite den Text direkt in den Formen.',
  graphicCategoryList: 'Liste',
  graphicCategoryProcess: 'Prozess',
  graphicCategoryCycle: 'Zyklus',
  graphicCategoryHierarchy: 'Hierarchie',
  graphicCategoryRelationship: 'Beziehung',
  graphicCategoryMatrix: 'Matrix',
  graphicCategoryPyramid: 'Pyramide',
  graphicLayoutListBlock: 'Blockliste',
  graphicLayoutListHorizontal: 'Horizontale Liste',
  graphicLayoutProcessChevron: 'Chevron-Prozess',
  graphicLayoutProcessSteps: 'Schrittprozess',
  graphicLayoutCycleBasic: 'Einfacher Zyklus',
  graphicLayoutHierarchyOrg: 'Organisation',
  graphicLayoutRelationshipOpposing: 'Gegenüberstellung',
  graphicLayoutRelationshipRadial: 'Radial',
  graphicLayoutMatrixGrid: 'Rastermatrix',
  graphicLayoutPyramidBasic: 'Pyramide',
  graphicTools: 'Grafik',
  graphicTextPane: 'Textbereich',
  graphicAddItem: 'Element hinzufügen',
  graphicRemoveItem: 'Element entfernen',
  graphicMoveUp: 'Nach oben',
  graphicMoveDown: 'Nach unten',
  graphicPromote: 'Höherstufen',
  graphicDemote: 'Tieferstufen',
  graphicLayout: 'Layout',
  graphicColorSet: 'Farben',
  graphicStyle: 'Stil',
  graphicStyleFilled: 'Gefüllt',
  graphicStyleOutline: 'Umrandet',
  graphicStyleSubtle: 'Dezent',
  graphicStyleIntense: 'Kräftig',
  graphicColorTheme: 'Thema',
  graphicColorBlue: 'Blau',
  graphicColorGreen: 'Grün',
  graphicColorOrange: 'Orange',
  graphicColorPurple: 'Violett',
