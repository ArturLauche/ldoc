...
const EnhancedImage = Image.extend({
  addAttributes() {
    return {
      ...
      smartArtType: {
        default: null,
        parseHTML: (element) => element.getAttribute('data-smartart-type'),
        renderHTML: (attributes) =>
          attributes.smartArtType
            ? {
                'data-smartart-type': attributes.smartArtType,
              }
            : {},
      },
      smartArtItems: {
        default: null,
        parseHTML: (element) => element.getAttribute('data-smartart-items'),
        renderHTML: (attributes) =>
          attributes.smartArtItems
            ? {
                'data-smartart-items': attributes.smartArtItems,
              }
            : {},
      },
      smartArtOptions: {
        default: null,
        parseHTML: (element) => element.getAttribute('data-smartart-options'),
        renderHTML: (attributes) =>
          attributes.smartArtOptions
            ? {
                'data-smartart-options': attributes.smartArtOptions,
              }
            : {},
      },
    };
